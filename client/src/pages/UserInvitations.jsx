...
const UserInvitations = () => {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-surface-900 tracking-tight">Your Invitations</h1>
        <p className="text-sm text-surface-500 mt-1">Accept or reject invitations to join organizations</p>
      </div>
