...
const CreateIssueModal = ({ organizationId, projectId, onIssueCreated }) => {
  const { isCreateIssueModalOpen, setCreateIssueModalOpen } = useUIStore();
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const newIssue = await issueService.createIssue(organizationId, projectId, formattedData);
  ...
  return (
    <div className="fixed z-50 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" aria-hidden="true" onClick={() => setCreateIssueModalOpen(false)}></div>
